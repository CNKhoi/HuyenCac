/* Auto-generated runtime bundle for file:// + GitHub Pages. Source modules remain in assets/js/. */
(function(){
'use strict';

/* ===== data/mystical-data.js ===== */
const MysticalData = Object.freeze({
  STORE:'huyen-cac-pro-profile-v5', TZ:7,
  STEMS:['Giáp','Ất','Bính','Đinh','Mậu','Kỷ','Canh','Tân','Nhâm','Quý'],
  BRANCHES:['Tý','Sửu','Dần','Mão','Thìn','Tỵ','Ngọ','Mùi','Thân','Dậu','Tuất','Hợi'],
  ANIMALS:['Chuột','Trâu','Hổ','Mèo','Rồng','Rắn','Ngựa','Dê','Khỉ','Gà','Chó','Lợn'],
  STEM_ELEMENT:['Mộc','Mộc','Hỏa','Hỏa','Thổ','Thổ','Kim','Kim','Thủy','Thủy'],
  BRANCH_ELEMENT:['Thủy','Thổ','Mộc','Mộc','Thổ','Hỏa','Hỏa','Thổ','Kim','Kim','Thổ','Thủy'],
  STEM_POLARITY:['Dương','Âm','Dương','Âm','Dương','Âm','Dương','Âm','Dương','Âm'],
  BRANCH_POLARITY:['Dương','Âm','Dương','Âm','Dương','Âm','Dương','Âm','Dương','Âm','Dương','Âm'],
  ELEMENT_TEXT:{Mộc:'phát triển, mở rộng, học hỏi và thích nghi',Hỏa:'hành động, biểu đạt, nhiệt huyết và tốc độ',Thổ:'ổn định, cấu trúc, thực tế và bền bỉ',Kim:'kỷ luật, ranh giới, rõ ràng và quyết đoán',Thủy:'linh hoạt, quan sát, trực giác và kết nối'},
  ...
  SIX_HARMONY:{0:1,1:0,2:11,11:2,3:10,10:3,4:9,9:4,5:8,8:5,6:7,7:6},
  GENERATES:{Mộc:'Hỏa',Hỏa:'Thổ',Thổ:'Kim',Kim:'Thủy',Thủy:'Mộc'},
  CONTROLS:{Mộc:'Thổ',Thổ:'Thủy',Thủy:'Hỏa',Hỏa:'Kim',Kim:'Mộc'},
  ZODIAC:[
    ['Ma Kết','♑','thực tế, có cấu trúc, bền bỉ và thiên về mục tiêu dài hạn'],['Bảo Bình','♒','độc lập, thích ý tưởng mới và có xu hướng nhìn vấn đề theo hệ thống'],['Song Ngư','♓','nhạy cảm, giàu tưởng tượng, trực giác và khả năng đồng cảm'],['Bạch Dương','♈','chủ động, nhanh, thẳng và có xu hướng mở đường'],['Kim Ngưu','♉','ổn định, kiên trì, coi trọng giá trị và tiến từng bước chắc chắn'],['Song Tử','♊','tò mò, giao tiếp nhanh, linh hoạt và thích nhiều góc nhìn'],['Cự Giải','♋','quan tâm cảm xúc, sự an toàn, gia đình và ký ức trải nghiệm'],['Sư Tử','♌','ấm áp, biểu đạt rõ, thích tạo dấu ấn và truyền năng lượng'],['Xử Nữ','♍','phân tích, tỉ mỉ, chú ý tính hữu dụng và cải thiện liên tục'],['Thiên Bình','♎','cân bằng, ngoại giao, coi trọng quan hệ và tính hài hòa'],['Bọ Cạp','♏','sâu sắc, tập trung, kín đáo và có khả năng theo đuổi đến cùng'],['Nhân Mã','♐','cởi mở, ham khám phá, hướng tương lai và coi trọng tự do']
  ],
  NUM_TEXT:{
    1:['Người Khởi Xướng','độc lập, chủ động, thích bắt đầu và tự quyết','học cách cộng tác mà không mất tính tự chủ'],2:['Người Kết Nối','nhạy cảm với quan hệ, phối hợp tốt, tinh tế','giữ ranh giới và nói rõ nhu cầu thay vì chỉ chiều theo'],3:['Người Biểu Đạt','sáng tạo, giao tiếp, tạo không khí và truyền cảm hứng','biến cảm hứng thành nhịp làm việc đều và có đầu ra'],4:['Người Xây Nền','có hệ thống, thực tế, đáng tin và kiên trì','tránh cứng nhắc khi hoàn cảnh cần đổi cách làm'],5:['Người Khám Phá','linh hoạt, thích trải nghiệm, tự do và chuyển động','giữ trọng tâm để không bị phân tán bởi quá nhiều lựa chọn'],6:['Người Chăm Sóc','trách nhiệm, quan tâm cộng đồng, thẩm mỹ và sự hài hòa','không ôm trách nhiệm của tất cả mọi người'],7:['Người Chiêm Nghiệm','đào sâu, phân tích, nghiên cứu và cần không gian riêng','đưa suy nghĩ trở lại dữ kiện và trải nghiệm thực tế'],8:['Người Điều Hành','hướng kết quả, nguồn lực, tổ chức và năng lực quản trị','cân bằng hiệu quả với con người và giới hạn thực tế'],9:['Người Nhân Văn','góc nhìn rộng, cảm thông, lý tưởng và mong tạo tác động','đặt ranh giới để lý tưởng không trở thành phân tán'],11:['Người Truyền Cảm Hứng','trực giác, độ nhạy và khả năng nhận ra ý nghĩa phía sau sự việc','tạo nền tảng thực tế để tránh quá tải cảm xúc'],22:['Người Kiến Tạo','khả năng biến tầm nhìn lớn thành hệ thống cụ thể','chia mục tiêu lớn thành cấu trúc có thể thực thi'],33:['Người Phụng Sự','năng lượng chăm sóc, nâng đỡ và trách nhiệm cộng đồng','chăm sóc chính mình trước khi gánh quá nhiều']
  },
  CYCLE_TEXT:{1:'Khởi đầu: chủ động, thử hướng mới, đặt nền cho chu kỳ kế tiếp.',2:'Hợp tác: kiên nhẫn, quan hệ, lắng nghe và tinh chỉnh.',3:'Biểu đạt: giao tiếp, sáng tạo, kết nối và đưa ý tưởng ra ngoài.',4:'Xây nền: kỷ luật, quy trình, sức bền và tính ổn định.',5:'Thay đổi: linh hoạt, trải nghiệm, dịch chuyển và điều chỉnh.',6:'Trách nhiệm: gia đình, cam kết, chăm sóc và cân bằng.',7:'Chiêm nghiệm: học sâu, đánh giá lại, nghiên cứu và giảm nhiễu.',8:'Thành tựu: kết quả, tài chính, quyền hạn và quản trị.',9:'Hoàn tất: tổng kết, buông phần không còn phù hợp và đóng chu kỳ.'},
  TAROT:[
    ['0','The Fool','khởi đầu, cởi mở, thử nghiệm và bước vào điều mới','bốc đồng, thiếu chuẩn bị hoặc ngại bước ra khỏi vùng quen thuộc'],['I','The Magician','chủ động, kỹ năng, nguồn lực và khả năng biến ý tưởng thành hành động','nguồn lực bị phân tán hoặc bạn đang đánh giá thấp năng lực sẵn có'],['II','The High Priestess','trực giác, quan sát và phần thông tin chưa cần phơi bày','nhiễu trực giác, thiếu dữ kiện hoặc cảm giác có điều chưa rõ'],['III','The Empress','nuôi dưỡng, sáng tạo, phát triển và tạo điều kiện cho thứ gì đó lớn lên','chăm quá nhiều cho bên ngoài hoặc thiếu chăm sóc nguồn lực của chính mình'],['IV','The Emperor','cấu trúc, kỷ luật, trách nhiệm và ranh giới','kiểm soát quá mức hoặc ngược lại thiếu một hệ thống đủ vững'],['V','The Hierophant','hệ giá trị, kiến thức truyền thống, người hướng dẫn và chuẩn mực','cần xem lại khuôn mẫu cũ hoặc tự xây nguyên tắc phù hợp hơn'],['VI','The Lovers','giá trị, lựa chọn, kết nối và sự đồng thuận','bất đồng giá trị, do dự hoặc một lựa chọn chưa thật sự nhất quán'],['VII','The Chariot','ý chí, hướng đi, kiểm soát lực kéo đối lập và tiến về mục tiêu','mất phương hướng, thúc ép quá nhanh hoặc các phần chưa phối hợp'],['VIII','Strength','sức mạnh mềm, kiên nhẫn và khả năng điều hòa phản ứng','tự nghi ngờ, kiệt sức hoặc dùng lực quá mạnh cho vấn đề cần mềm dẻo'],['IX','The Hermit','tĩnh lại, tìm hiểu sâu và tự soi chiếu','cô lập quá lâu hoặc suy nghĩ vòng lặp mà chưa kiểm chứng'],['X','Wheel of Fortune','chu kỳ đổi chiều, điều kiện mới và cơ hội cần thích nghi','khó chấp nhận biến động hoặc cố kiểm soát thứ vốn đang thay đổi'],['XI','Justice','công bằng, hệ quả, dữ kiện và quyết định có trách nhiệm','thiên kiến, né hệ quả hoặc chưa cân đủ hai phía'],['XII','The Hanged Man','tạm dừng, đổi góc nhìn và chấp nhận chưa hành động','trì hoãn vô ích hoặc mắc kẹt vì không chịu đổi cách nhìn'],['XIII','Death','kết thúc cần thiết, chuyển hóa và dọn chỗ cho giai đoạn mới','bám giữ điều đã hết vai trò hoặc trì hoãn một thay đổi cần thiết'],['XIV','Temperance','điều độ, phối hợp, cân bằng và tích hợp','nhịp sống lệch, quá đà hoặc thiếu kiên nhẫn trong quá trình điều chỉnh'],['XV','The Devil','ràng buộc, ham muốn, thói quen và phần cần nhìn thẳng','bắt đầu nhận ra ràng buộc và có cơ hội lấy lại quyền lựa chọn'],['XVI','The Tower','sự thật làm lung lay cấu trúc không còn vững','thay đổi bị trì hoãn hoặc tác động có thể giảm nếu chuẩn bị sớm'],['XVII','The Star','hy vọng, định hướng, hồi phục và niềm tin có cơ sở','mất động lực hoặc kỳ vọng đang xa khỏi dữ kiện thực tế'],['XVIII','The Moon','mơ hồ, cảm xúc, trực giác và vùng thông tin chưa rõ','sự thật đang dần lộ ra nhưng vẫn cần kiểm chứng trước khi kết luận'],['XIX','The Sun','sáng rõ, năng lượng, sự tự tin và tiến triển tích cực','kết quả tốt có thể có nhưng cần thực tế và tránh chủ quan'],['XX','Judgement','tổng kết, thức tỉnh và một quyết định có tính chuyển giai đoạn','tự phán xét quá mức hoặc né một quyết định đã đến lúc phải nhìn thẳng'],['XXI','The World','hoàn tất, tích hợp, thành tựu và chuẩn bị mở chu kỳ mới','còn một mắt xích chưa khép hoặc cần hoàn thiện trước khi chuyển sang bước khác']
  ],
  TOPIC_NAME:{general:'Tổng quan',love:'Tình cảm',work:'Công việc',finance:'Tài chính',study:'Học tập',decision:'Quyết định'},
  TOPIC_LENS:{general:['bức tranh tổng thể','điều cần ưu tiên','bước tiếp theo'],love:['mẫu quan hệ hoặc cảm xúc nền','động lực giữa hai phía','ranh giới hoặc cách giao tiếp cần ưu tiên'],work:['kinh nghiệm hoặc cấu trúc đã hình thành','nút thắt vận hành hiện tại','hành động có thể cải thiện kết quả'],finance:['thói quen và nền tảng nguồn lực','rủi ro hoặc cơ hội đang hiện diện','nguyên tắc cần giữ trước khi quyết định tiền bạc'],study:['nền tảng kỹ năng và thói quen','điểm đang cản trở tiến độ','cách học hoặc ưu tiên cần thử'],decision:['điều đang ảnh hưởng lựa chọn','yếu tố quan trọng chưa được cân đủ','tiêu chí nên dùng để chốt quyết định']},
  TAROT_PRESETS:{general:['Điều gì tôi cần chú ý nhất ở thời điểm này?','Năng lượng nổi bật trong 30 ngày tới là gì?','Tôi đang bỏ sót điều quan trọng nào?'],love:['Điều gì đang ảnh hưởng nhiều nhất đến đời sống tình cảm của tôi?','Tôi cần hiểu gì về mối quan hệ hiện tại?','Tôi nên điều chỉnh điều gì để tình cảm lành mạnh hơn?'],work:['Tôi nên ưu tiên điều gì để công việc tiến triển tốt hơn?','Nút thắt lớn nhất trong công việc hiện tại là gì?','Cơ hội nghề nghiệp nào tôi nên chuẩn bị để đón nhận?'],finance:['Tôi cần lưu ý điều gì về cách quản lý tiền lúc này?','Rủi ro tài chính nào tôi nên kiểm tra kỹ hơn?','Tôi nên ưu tiên ổn định hay mở rộng nguồn lực?'],study:['Tôi nên thay đổi cách học hoặc phát triển bản thân thế nào?','Điều gì đang cản trở tiến độ học tập của tôi?','Kỹ năng nào nên ưu tiên trong giai đoạn này?'],decision:['Điều gì tôi chưa cân đủ trước quyết định này?','Rủi ro và cơ hội chính của lựa chọn hiện tại là gì?','Tiêu chí nào nên được ưu tiên trước khi chốt?']},
  AUTO_DOMAINS:[
    {topic:'general',label:'TỔNG QUAN',title:'Bức tranh chung',lens:'năng lượng và điều kiện tổng thể'},
    {topic:'love',label:'TÌNH CẢM',title:'Tình cảm & quan hệ',lens:'cảm xúc, kết nối và ranh giới'},
    {topic:'work',label:'CÔNG VIỆC',title:'Công việc & hướng đi',lens:'vận hành, tiến độ và quyết định nghề nghiệp'},
    {topic:'finance',label:'TÀI CHÍNH',title:'Nguồn lực & tiền bạc',lens:'quản lý nguồn lực, rủi ro và độ ổn định'},
    {topic:'study',label:'PHÁT TRIỂN',title:'Học tập & nội lực',lens:'kỹ năng, thói quen và phát triển cá nhân'},
    {topic:'decision',label:'ƯU TIÊN',title:'Điều cần chú ý',lens:'điểm cần kiểm chứng trước khi hành động'}
  ],
  KUA_INFO:{1:{gua:'Khảm',element:'Thủy',group:'Đông tứ mệnh',directions:'Bắc • Đông • Nam • Đông Nam'},2:{gua:'Khôn',element:'Thổ',group:'Tây tứ mệnh',directions:'Đông Bắc • Tây • Tây Bắc • Tây Nam'},3:{gua:'Chấn',element:'Mộc',group:'Đông tứ mệnh',directions:'Bắc • Đông • Nam • Đông Nam'},4:{gua:'Tốn',element:'Mộc',group:'Đông tứ mệnh',directions:'Bắc • Đông • Nam • Đông Nam'},6:{gua:'Càn',element:'Kim',group:'Tây tứ mệnh',directions:'Đông Bắc • Tây • Tây Bắc • Tây Nam'},7:{gua:'Đoài',element:'Kim',group:'Tây tứ mệnh',directions:'Đông Bắc • Tây • Tây Bắc • Tây Nam'},8:{gua:'Cấn',element:'Thổ',group:'Tây tứ mệnh',directions:'Đông Bắc • Tây • Tây Bắc • Tây Nam'},9:{gua:'Ly',element:'Hỏa',group:'Đông tứ mệnh',directions:'Bắc • Đông • Nam • Đông Nam'}},
...
const FeatureConfig={
  tarot:{accent:'amethyst',icon:'#i-tarot',title:'Tarot'},
  fortune:{accent:'emerald',icon:'#i-number',title:'Thần số học'},
  horoscope:{accent:'gold',icon:'#i-horoscope',title:'Tử vi'},
  compatibility:{accent:'rose',icon:'#i-compatibility',title:'Độ hợp'},
  dates:{accent:'blue',icon:'#i-calendar',title:'Xem ngày'}
};
