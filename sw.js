const CACHE='huyen-cac-v5.7-static-v1';
const CORE=[
  ...
  './assets/css/motion.css','./assets/css/responsive.css','./assets/css/expert.css','./assets/css/ux-v55.css','./assets/js/app.bundle.js'
];
